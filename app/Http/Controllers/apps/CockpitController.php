...
class CockpitController extends Controller {
    ...
    public function index() {
        $dados['contas'] = DB::table('account_live_data as ald')
        ...
        $dados['operacoes'] = DB::table('positions_live_data as pld')
        ...
        //Log::info(DB::getQueryLog());
        return view('apps.cockpit.index', ['dados_conta' => $dados['contas'], 'dados_operacoes' => $dados['operacoes']]);
    }

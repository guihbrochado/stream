                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Adicionar Curso</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form class="row g-3 needs-validation" action="{{ route('courses.store') }}" method="post" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="price" name="price" type="text" class="form-control maskmoney3" id="duration" required />
                                        <div class="invalid-feedback">
                                            Este campo é obrigatório
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="" id="isfree" name="isfree" />

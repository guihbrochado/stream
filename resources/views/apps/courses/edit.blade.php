                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="row g-3 needs-validation" action="{{ route('courses.store', ['id' => $data->id] ) }}" method="post" enctype="multipart/form-data" novalidate>
                                    @csrf
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" class="form-control" id="expiration" name="expiration" value="{{$data->expiration}}" required />
                                        <div class="invalid-feedback">
                                            Este campo é obrigatório
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <input id="price" name="price" value="{{$data->price}}" type="text" class="form-control" id="duration" required />
                                        <div class="invalid-feedback">
                                            Este campo é obrigatório
                                        </div>
                                    </div>

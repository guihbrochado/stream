                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ route('courses.create') }}" class="btn btn-primary "> Adicionar</a>
                                </div>
                                    ...
                                    <table id="datatable" class="table " data-toggle="data-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Possui certificado?</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{date("d/m/Y", strtotime($row->expiration))}}</td>

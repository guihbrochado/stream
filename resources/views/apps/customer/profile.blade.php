            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="text-center">
                        <div class="dropdown float-end">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ route('customer.editProfile', $user->id) }}">Edit</a>
                                <a class="dropdown-item" href="{{ route('customer.destroy', $user->id) }}">Remove</a>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @else
                                <span class="avatar-initial rounded-circle bg-label-secondary">{{ strtoupper(substr($user->name, 0, 2)) }}</span>
                            @endif
                        </div>
                    ...
                    <div class="text-muted">
                        <h5 class="font-size-16">Sobre</h5>
                        ...
                        <div class="table-responsive mt-4">
                            ...
                            <div class="mt-4">
                                ...
                                <h5 class="font-size-16">{{ $user->street }}, {{ $user->district }}, {{ $user->city }}, {{ $user->state }}</h5>
                            </div>
            ...
            <div class="tab-content p-4">
                <div class="tab-pane active" id="about" role="tabpanel">
                    <div>
                        ...
                        <div>
                            <h5 class="font-size-16 mb-4">Pagamentos</h5>

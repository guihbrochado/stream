...
<head>
    ...
    <style>
        .video-container {
            position: relative;
            max-width: 100%;
            /* Utilize 100% para largura total, ajuste conforme necessário */
            margin: auto;
            overflow: hidden;
            /* Para garantir que nada saia fora do contêiner */
        }
        ...
        .video-cover {
            ...
            height: 100%;
            object-fit: cover;
            /* Isso garante que a imagem cubra o espaço sem perder as proporções */
            z-index: 2;
            /* Garante que a imagem fique sobre o vídeo */
        }
        ...
        .btn-play {
            ...
            outline: none;
            /* Remove o contorno quando focado */
            cursor: pointer;
        ...
        .btn-play:hover {
            ...
            /* Muda o fundo para um pouco mais escuro quando passa o mouse */
        }

        .btn-play:focus {
            outline: none;
            /* Remove o contorno quando clicado */
        }
    </style>
</head>

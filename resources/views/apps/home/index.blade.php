                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        <h4 class="card-title">Inicio Configurações</h4>
                                    </div>
                                    <div>
                                        <a href="{{ route('inicio.create') }}" class="btn btn-primary">Adicionar Configuração</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive border rounded py-4">
                                        <table id="datatable" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center">{{ $inicio->id }}</td>
                                                    <td class="text-center"><img src="{{ asset(''.$inicio->logo_path) }}" alt="Logo" style="max-width: 100px;"></td>
                                                    <td class="text-center"><img src="{{ asset(''.$inicio->cover_path) }}" alt="Capa" style="max-width: 100px;"></td>
                                                    <td class="text-center">{{ $inicio->created_at->format('d/m/Y') }}</td>
                                                    <td class="text-center">
                                                        <a href="{{ route('inicio.edit', $inicio->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                                        <form action="{{ route('inicio.destroy', $inicio->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')

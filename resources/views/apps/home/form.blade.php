                        ...
                        <div class="col-xl-9 col-lg-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ $action == 'create' ? route('inicio.store') : route('inicio.update', $inicio->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @if($action == 'edit')
                                        @method('PUT')
                                        @endif
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            @if($inicio->logo_path)
                                            <img src="{{ asset(''.$inicio->logo_path) }}" alt="Logo" style="max-width: 100px; max-height: 100px;">
                                            @endif
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="cover">Capa (Opcional):</label>
                                            <input type="file" class="form-control" id="cover" name="cover">
                                            @if($inicio->cover_path)
                                            <img src="{{ asset(''.$inicio->cover_path) }}" alt="Cover" style="max-width: 100px; max-height: 100px;">
                                            @endif
                                        </div>

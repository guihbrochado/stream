                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="row g-3 needs-validation" action="{{ route('blogcategory.update', ['id' => $data->id] ) }}" method="post" enctype="multipart/form-data" novalidate>
                                    @csrf
                                    @php $message = "Este campo é obrigatório"; @endphp
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="form-label" for="description">Descrição</label>
                                            <input id="description" value="{{ $data->description }}" required name="description" type="text" class="form-control @error('description') is-invalid @enderror" placeholder="Aula" maxlength="100" />
                                            @error('data')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <option {{ $data->status == 1 ? 'selected' : ''}} value="1"> Ativo </option>
                                            <option {{ $data->status == 0 ? 'selected' : ''}} value="0"> Inativo </option>
                                        </select>
                                        </div>
                                    </div>

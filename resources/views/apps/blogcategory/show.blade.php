                                ...
                                <form class="row g-3 needs-validation" action="{{ route('blogstream.update', ['id' => $data->id] ) }}" method="post" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input id="description" value="{{ $data->description }}" disabled name="description" type="text" class="form-control @error('description') is-invalid @enderror" placeholder="Aula" maxlength="100" />
                                            @error('data')

                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ route('blogcategory.create') }}" class="btn btn-primary "> Adicionar</a>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('blogcategory.show', ['id' => $row->id]) }}"> <i class="fa-solid fa-eye  me-2 lh-lg"></i> </a>
                                                    <a href="{{ route('blogcategory.edit', ['id' => $row->id]) }}"> <i class="fa-solid fa-user-edit  me-2 lh-lg"></i> </a>
                                                    <a href="{{ route('blogcategory.destroy', ['id' => $row->id]) }}"> <i class="fa-solid fa-trash  me-2 lh-lg"></i> </a>
                                                </td>
                                            </tr>
                                            @endforeach

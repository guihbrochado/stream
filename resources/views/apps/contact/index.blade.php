                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="title-box">
                                <h2>Crie conosco</h2>
                                <p class="mb-0">Para saber mais sobre como o Streamit pode ajudá-lo, entre em contato conosco.</p>
                            </div>
                            <form class="mb-5 mb-lg-0">
                                <div class="row">
                                    <div class="col-md-6 mb-4 mb-lg-5">
                                        <input type="text" class="form-control font-size-14" placeholder="Seu Nome*" required>
                                    </div>
                                    <div class="col-md-6 mb-4 mb-lg-5">
                                        <input type="text" class="form-control font-size-14" placeholder="Ultimo Nome*" required>
                                    </div>
                                    <div class="col-md-6 mb-4 mb-lg-5">
                                        <input type="tel" class="form-control font-size-14" maxlength="140" minlength="10" placeholder="Telefone*" required>
                                    </div>
                                    <div class="col-md-6 mb-4 mb-lg-5">
                                        <input type="email" class="form-control font-size-14" placeholder="Seu Email*" required>
                                    </div>
                                    <div class="col-md-12 mb-4 mb-lg-5">
                                        <textarea class="form-control font-size-14" cols="40" rows="10" placeholder="Sua Menssagem"></textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="iq-button">
            ...
            <div class="section-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="title-box">
                                <h3 class="fw-500">Para saber mais sobre como o Streamit pode ajudá-lo, entre em contato conosco. Ficaríamos felizes em aceitar o desafio!</h3>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
                                ...
                                <div style="z-index: 1;">
                                    <h6 class="font-size-18 fw-500 mb-4">Para consultas gerais</h6>
                                    <p class="mb-1 font-size-14">Ligar: <span class="text-primary">(144) 1234 4567</span>
                                    </p>
                                    <p class="mb-0">Email: <a href="mailto:info@medyapim.com" class="text-white fw-500">info@enquiries.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="contact-box d-flex gap-3 rounded mb-3 mb-lg-0">
                                ...
                                <div style="z-index: 1;">
                                    <h6 class="font-size-18 fw-500 mb-4">Para suporte ao usuário</h6>
                                    <p class="mb-1 font-size-14">Ligar: <span class="text-primary">(144) 4321 4567</span>
                                    </p>
                                    <p class="mb-0">Email: <a href="mailto:info@medyapim.com" class="text-white fw-500">support@enquiries.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="contact-box d-flex gap-3 rounded">
                                ...
                                <div style="z-index: 1;">
                                    <h6 class="font-size-18 fw-500 mb-4">Para suporte de vendas</h6>
                                    <p class="mb-1 font-size-14">Ligar: <span class="text-primary">(144) 1234 1234</span>
                                    </p>
                                    <p class="mb-0">Email: <a href="mailto:info@medyapim.com" class="text-white fw-500">user@enquiries.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>

                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="row g-3 needs-validation" action="{{ route('coursesmodules.update', ['id' => $data->id]) }}" method="post" novalidate>
                                    @csrf
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" id="modulenumber" name="modulenumber" value="{{$data->modulenumber}}" required />
                                        <div class="invalid-feedback">
                                            Este campo é obrigatório
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="id_course" name="id_course" required>
                                            ...
                                            <option value="<?= $row->id; ?>" <?= $row->id == $data->id_course ? 'selected' : ''?>><?= $row->course ?></option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-feedback">
                                            Este campo é obrigatório

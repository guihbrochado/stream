                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ route('about.create') }}" class="btn btn-primary ">Adicionar</a>
                                </div>
                                    ...
                                    <table id="datatable" class="table" data-toggle="data-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">E-mail de Contato</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{ Str::limit($about->description, 50) }}</td>
                                                <td class="text-center">{{ $about->contact_email }}</td>
                                                <td class="text-center">{{ date('d/m/Y', strtotime($about->created_at)) }}</td>
                                                <td class="text-center">
                                                    <a href="{{ route('about.edit', $about->id) }}"> <i class="fas fa-edit me-2 lh-lg"></i> </a>

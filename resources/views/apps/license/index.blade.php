                ...
                var dt_user = dt_table.DataTable({
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            targets: 4,
                            render: function(data, type, full, meta) {
                                if (full['validity'] != null) {
                                    var $due_date = new Date(full['validity']);
                                    // Creates full output for row
                                    var $row_output =
                                        '<span class="d-none">' +
                                        moment.utc($due_date).format('YYYYMMDD') +
                                        '</span>' +
                                        moment.utc($due_date).format('DD-MM-YYYY');
                                    $due_date;
                                    return $row_output;
                                } else {
                                    return "";
                        ...
                        },
                        {
                            ...
                            targets: 5,
                            render: function(data, type, full, meta) {
                                var $active = (full['lifetime']) ? "Sim" : "Não";
                                return $active;
                            }
                        },
                        {
                            ...
                            targets: 6,
                            render: function(data, type, full, meta) {
                                return number_format(full['volume'], 2, ',', '');
                            }
                        },
                        {
                            // Pausado
                            targets: 7,
                            render: function(data, type, full, meta) {
                                var $paused = (full['paused']) ? "Sim" : "Não";
                                return $paused;
                            }
                        },
                        {

                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ $action == 'create' ? route('category.store') : route('category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @if($action == 'edit')
                                    @method('PUT')
                                    @endif
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="nome">Nome Categoria:</label>
                                            <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome Categoria" value="{{ old('nome', $category->nome) }}" required>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-primary mt-3">{{ $action == 'create' ? 'Criar Categoria' : 'Atualizar Categoria' }}</button>
                                </form>
                            </div>
                        </div>
                    </div>

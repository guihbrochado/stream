                                            ...
                                            <div class="row align-items-center h-100">
                                                <div class="col-lg-6 col-md-12">
                                                    ...
                                                    <div class="RightAnimate-four">
                                                        <div class="iq-button">
                                                            <a href="{{ route('course.detail') }}" class="btn text-uppercase position-relative">
                                ...
                                <li class="swiper-slide">
                                    <div class="iq-top-ten-block">
                                        <div class="block-image position-relative">
                                            <div class="img-box">
                                                <a class="overly-images" href="{{ route('course.detail') }}">
                                        ...
                                        <div class="iq-card card-hover">
                                            <div class="block-images position-relative w-100">
                                                <div class="img-box w-100">
                                                    <a href="{{ route('course.detail') }}" class="position-absolute top-0 bottom-0 start-0 end-0"></a>
                                                    ...
                                                    <div class="cart-content">
                                                        <div class="content-left">
                                                            <h5 class="iq-title text-capitalize">
                                                                <a href="{{ route('course.detail') }}">{{$row->course}}</a>
                                                            </h5>
                                                ...
                                                <div class="block-social-info align-items-center">
                                                    ...
                                                    <div class="iq-button">
                                                        <a href="{{ route('course.detail') }}" class="btn text-uppercase position-relative rounded-circle">

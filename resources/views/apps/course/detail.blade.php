                                    ...
                                    <div id="evaluation" class="tab-pane animated fadeInUp mb-2" role="tabpanel">
                                        <form action="{{ route('courseevaluation.store', ['idcourse' => $data->id]) }}" method="post">
                                            ...
                                            <div class="d-flex gap-1 align-items-center">
                                                ...
                                                <textarea class="mx-2 p-1" required name="textevaluation" id="textevaluation" placeholder="Faça sua avaliação..." cols="200" rows="2" style="border:none;"></textarea>
                                        ...
                                        <div class="source-list-content table-responsive">
                                            <table class="table custom-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    @empty
                                                <h6> Faça a primeira avaliação!</h6>
                                                @endforelse

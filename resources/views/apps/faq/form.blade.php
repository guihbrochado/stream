                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Adicionar FAQ</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                @if(session('message'))
                                ...
                                <form action="{{ route('faq.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="faq_categories_id">Categoria:</label>
                                            <select class="form-control" id="faq_categories_id" name="faq_categories_id" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="icon" name="icon" placeholder="Ícone (opcional)">
                                        </div>
                                        <!-- Campo Pergunta -->
                                        <div class="form-group col-md-12">
                                            <label for="question">Pergunta:</label>
                                            <input type="text" class="form-control" id="question" name="question" placeholder="Digite a pergunta" required>
                                        </div>
                                        <!-- Campo Resposta -->
                                        <div class="form-group col-md-12">
                                            <label for="answer">Resposta:</label>
                                            <textarea class="form-control" id="answer" name="answer" rows="4" placeholder="Digite a resposta" required></textarea>
                                        </div>
                                    </div>

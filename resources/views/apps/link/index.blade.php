            ...
            <div class="row align-items-center">
                  <div class="col-sm-12">
                      <nav aria-label="breadcrumb" class="text-center">
                          <h2 class="title">Birds Of Prey Star Says She’s Definitely Open To A Ghost Return</h2>
                          <ol class="breadcrumb justify-content-center">
                              <li class="breadcrumb-item"><a href="index.html">Home</a></li> 
                              <li class="breadcrumb-item active">Birds Of Prey Star Says She’s Definitely Open To A Ghost Return</li>
                          </ol>
                      </nav>
                  </div>
              </div> 

...
<html lang="en" data-bs-theme="dark">
    ...
    <body class="  ">
        ...
        <main class="main-content">
            ...
            <div class="vh-100" style="background: url('{{ isset($inicio) && $inicio->cover_path ? asset('' . $inicio->cover_path) : './assets/images/pages/01.webp' }}'); background-size: cover; background-repeat: no-repeat; position: relative; min-height:500px">
<div class="container">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="float-end">
                                            ...
                                            <a href="{{ route('password.request') }}" class="text-primary fw-semibold fst-italic">Esqueceu a senha?</a>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-3 text-center">
                                        <button class="btn btn-primary waves-effect waves-light w-100" type="submit">Login</button>
                                    </div>

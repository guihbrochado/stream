        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Saldo</span>
                        <h4 class="mb-3">
                            <span class="counter-value" data-target="865.2">R$ {{ number_format($data['saldo_total'], 2, ',', '') }}</span>k
                        </h4>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Fator de lucro</span>
                        <h4 class="mb-3">
                            <span class="counter-value" data-target="6258">{{ number_format($data['fator_lucro'], 2, ',', '') }}</span>
                        </h4>
                    </div>
                    <div class="col-6">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Drawdown maximo</span>
                        <h4 class="mb-3">
                            <span class="counter-value" data-target="4.32">R$ {{ number_format($data['drawdown_maximo'], 2, ',', '') }}</span>
                        </h4>
                    </div>
                    <div class="col-6">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-6">
                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Taxa de acerto</span>
                        <h4 class="mb-3">
                            <span class="counter-value" data-target="12.57">{{ number_format($data['taxa_acerto'], 2, ',', '') }}</span>%
                        </h4>
                    </div>
                    <div class="col-6">
...
<div class="row">
    <div class="col-xl-5">
        <!-- card -->
        <div class="card card-h-100" style="height: calc(100% - 20px);">
            <!-- card body -->
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center mb-4">
                    <h5 class="card-title me-2">Saldo da carteira</h5>
                    <div class="ms-auto">
                        <!--div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm align-self-center">
                        <div class="mt-4 mt-sm-0">
                            <div>
                                <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-success"></i> Indice</p>
                                <h6>0.4412 BTC = <span class="text-muted font-size-14 fw-normal">$ 4025.32</span></h6>
                            </div>

                            <div class="mt-4 pt-2">
                                <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-primary"></i> Dollar</p>
                                <h6>4.5701 ETH = <span class="text-muted font-size-14 fw-normal">$ 1123.64</span></h6>
                            </div>

                            <div class="mt-4 pt-2">
                                <p class="mb-2"><i class="mdi mdi-circle align-middle font-size-10 me-2 text-info"></i> Ações</p>
        ...
        <div class="row">
            <div class="col-xl-8">
                ...
                <div class="card card-h-100" style="height: calc(100% - 20px);">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap align-items-center mb-4">
                            <h5 class="card-title me-2">Média das operações</h5>
                            <div class="ms-auto">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm align-self-center">
                                <div class="mt-4 mt-sm-0">
                                    <p class="mb-1"></p>
                                    <h4>R$ {{ number_format($data['media_operacoes'], 2, ',', '') }}%</h4>
                                    ...
                                    <div class="row g-0">
                                        <div class="col-6">
                                            <div>
                                                <p class="mb-2 text-muted text-uppercase font-size-11">Média das operações positivas</p>
                                                <h5 class="fw-medium">R$ {{ number_format($data['media_profit'], 2, ',', '') }}%</h5>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div>
                                                <p class="mb-2 text-muted text-uppercase font-size-11">Média das operações negativas</p>
                                                <h5 class="fw-medium">R$ {{ number_format($data['media_perdas'], 2, ',', '') }}%</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="row">
    <div class="col-xl-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center mb-4">
                    <h5 class="card-title me-2">Visão geral</h5>
                    <div class="ms-auto">
                        <!--div>
                            <button type="button" class="btn btn-soft-primary btn-sm">
                                ALL
    ...
    <div class="col-xl-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center mb-4">
                    <h5 class="card-title me-2">Localizações</h5>
                    <div class="ms-auto">
                        <div class="dropdown">
                ...
                <div class="px-2 py-2">
                    <p class="mb-1">Brasil <span class="float-end">75%</span></p>
                    ...
                    <p class="mt-3 mb-1">USA <span class="float-end">55%</span></p>
                    <div class="progress mt-2" style="height: 6px;">
                    ...
                    <p class="mt-3 mb-1">Portugal <span class="float-end">85%</span></p>
                    <div class="progress mt-2" style="height: 6px;">
...
<script>
    var mediaOperacoes = @json($data['media_operacoes']);
    
    var options = {
    series: [{
        name: 'Média das Operações',
        data: [mediaOperacoes]
    }]
